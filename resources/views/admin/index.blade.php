            ...
            <div class="card-body">
              <div class="row mt-1 align-items-center">
                <div class="col-12 col-lg-4 text-left pl-4">
                  ...
                  <p class="text-muted mt-2"> Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam
                    eget dui </p>
                </div>
            ...
            <div class="card timeline shadow">
              ...
              <div class="card-body" data-simplebar="" style="height:355px; overflow-y: auto; overflow-x: hidden;">
                ...
                <div class="pb-3 timeline-item item-primary">
                  <div class="pl-5">
                    <div class="mb-1"><strong>@Brown Asher</strong><span class="text-muted small mx-2">Just create new
                        layout Index, form, table</span><strong>Tiny Admin</strong></div>
                ...
                <div class="pb-3 timeline-item item-warning">
                  <div class="pl-5">
                    <div class="mb-3"><strong>@Hester Nissim</strong><span class="text-muted small mx-2">has upload new
                        files to</span><strong>Tiny Admin</strong></div>
                    <div class="row mb-3">
                      <div class="col"><img src="{{ asset('backend/assets/products/p1.jpg') }}" alt="..." class="img-fluid rounded"></div>
                      <div class="col"><img src="{{ asset('backend/assets/products/p2.jpg') }}" alt="..." class="img-fluid rounded"></div>
                      <div class="col"><img src="{{ asset('backend/assets/products/p3.jpg') }}" alt="..." class="img-fluid rounded"></div>
                      <div class="col"><img src="{{ asset('backend/assets/products/p4.jpg') }}" alt="..." class="img-fluid rounded"></div>
                    </div>
                ...
                <div class="pb-3 timeline-item item-success">
                  <div class="pl-5">
                    <div class="mb-3"><strong>@Kelley Sonya</strong><span class="text-muted small mx-2">has commented
                        on</span><strong>Advanced table</strong></div>
                    <div class="card d-inline-flex mb-2">
                      <div class="card-body bg-light py-2 px-3 small rounded"> Lorem ipsum dolor sit amet, consectetur
                        adipiscing elit. Integer dignissim nulla eu quam cursus placerat. Vivamus non odio ullamcorper,
                        lacinia ante nec, blandit leo. </div>
                    </div>
                ...
                <div class="pb-3 timeline-item item-warning">
                  <div class="pl-5">
                    <div class="mb-3"><strong>@Fletcher Everett</strong><span class="text-muted small mx-2">created new
                        group for</span><strong>Tiny Admin</strong></div>
                    <ul class="avatars-list mb-3">
                      <li>
                        <a href="#!" class="avatar avatar-sm">
                          <img alt="..." class="avatar-img rounded-circle" src="{{ asset('backend/assets/avatars/face-1.jpg') }}">
                        </a>
                      </li>
                      <li>
                        <a href="#!" class="avatar avatar-sm">
                          <img alt="..." class="avatar-img rounded-circle" src="{{ asset('backend/assets/avatars/face-4.jpg') }}">
                        </a>
                      </li>
                      <li>
                        <a href="#!" class="avatar avatar-sm">
                          <img alt="..." class="avatar-img rounded-circle" src="{{ asset('backend/assets/avatars/face-3.jpg') }}">
                        </a>
                      </li>
                    </ul>
                    <p class="small text-muted">Front-End Development <span class="badge badge-light">1h ago</span>
                ...
                <div class="pb-3 timeline-item item-danger">
                  <div class="pl-5">
                    <div class="mb-3"><strong>@Lillith Joseph</strong><span class="text-muted small mx-2">has upload new
                        files to</span><strong>Tiny Admin</strong></div>
                    <div class="row mb-3">
                      <div class="col"><img src="{{ asset('backend/assets/products/p4.jpg') }}" alt="..." class="img-fluid rounded"></div>
                      <div class="col"><img src="{{ asset('backend/assets/products/p1.jpg') }}" alt="..." class="img-fluid rounded"></div>
                ...
                <table class="table table-striped table-hover table-borderless">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="dropdown">
                          <button class="btn btn-sm dropdown-toggle more-vertical" type="button" id="dr5"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="text-muted sr-only">Action</span>
                          </button>
