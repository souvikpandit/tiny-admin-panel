...
<form action="{{ route('tag.update',$tag->id) }}" id="tag_add" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="tile mb30">
                    <div class="tile-title-w-btn">
                        <div class="title">
                            <h3><i class="fe fe-24 fe-image"></i> Edit Tag</h3>
                        </div>
                        <p>
                            <a href="{{ route('tag.index') }}" class="btn btn-primary btn-oval trigger-button"><i class="lni-list"></i> All</a>
                        </p>
                    </div>
                    {{-- Messages --}}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="inputSearch">Tag Name</label>
                                    <input type="text" class="form-control mb-2" name="name" id="title" placeholder="Enter Tag" value="{{ $tag->name }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="inputSearch">Slug</label>
                                    <input type="text" class="form-control mb-2" name="slug" id="slug" placeholder="" value="{{ $tag->slug }}">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="mb-4 position-relative">
                                            ...
                                            <img src="{{ asset(GetImageUrl($tag->image)) }}" alt="" id="featured_preview_image" class="img-thumbnail" style="display:{{ ($tag->image) ? 'block' : 'none' }};">
                                            <input type="hidden" id="featured_thumbnail" name="image" value="{{ $tag->image }}">
