...
<form action="{{ route('tag.store') }}" id="tag_add" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="tile mb30">
                    <div class="tile-title-w-btn">
                        <div class="title">
                            <h3><i class="fe fe-24 fe-image"></i> Add Tag</h3>
                        </div>
                        <p>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-2" name="name" id="title" placeholder="Enter Tag" >
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
