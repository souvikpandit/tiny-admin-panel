...
<form action="{{ route('author.update',$author->id) }}" id="author_add" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="tile mb30">
                    <div class="tile-title-w-btn">
                        <div class="title">
                            <h3><i class="fe fe-24 fe-image"></i> Edit Author</h3>
                        </div>
                        <p>
                            <a href="{{ route('author.index') }}" class="btn btn-primary btn-oval trigger-button"><i class="lni-list"></i> All</a>
                        </p>
                    </div>
                    {{-- Messages --}}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="inputSearch">Author Name</label>
                                    <input type="text" class="form-control mb-2" name="name" id="title" placeholder="Enter Author" value="{{ $author->name }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="inputSearch">Slug</label>
                                    <input type="text" class="form-control mb-2" name="slug" id="slug" placeholder="" value="{{ $author->slug }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="mb-4 position-relative">
                                            ...
                                            <img src="{{ asset(GetImageUrl($author->image)) }}" alt="" id="featured_preview_image" class="img-thumbnail" style="display:{{ ($author->image) ? 'block' : 'none' }};">
                                            <input type="hidden" id="featured_thumbnail" name="image" value="{{ $author->image }}">
