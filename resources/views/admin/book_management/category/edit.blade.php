...
<form action="{{ route('book-category.update',$cat->id) }}" id="category_add" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="tile mb30">
                    <div class="tile-title-w-btn">
                        <div class="title">
                            <h3><i class="fe fe-24 fe-image"></i> Edit Book Category</h3>
                        </div>
                        <p>
