        ...
        <div class="card-body">
          <div class="tile mb30">
              <div class="tile-title-w-btn">
                  <div class="title">
                      <h3><i class="fe fe-24 fe-image"></i> Book Category</h3>
                  </div>
                  ...
                  <ul class="list-inline">
                      ...
                      <li class="list-inline-item"><a href="{{ route('book-category.create') }}" class="btn btn-primary btn-oval trigger-button"><i class="lni-plus"></i> Add New</a></li>
                  </ul>
              </div>
                            ...
                            @foreach ($categories as $category)
                              <tr id="tr_{{$category->id}}" data-id="{{$category->id}}">
                                <td>{{ $loop->iteration }}</td>
                                  ...
                                  <td>
                                      <a class="btn btn-sm btn-warning" href="{{ route('book-category.edit',$category->id) }}"><i class="feather icon-edit"></i> Edit</a>
