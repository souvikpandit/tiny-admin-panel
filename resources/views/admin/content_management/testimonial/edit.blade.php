...
<form action="{{ route('post.update', $testimonial->id) }}" id="testimonial_add" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="tile mb30">
                    <div class="tile-title-w-btn">
                        <div class="title">
                            <h3><i class="fe fe-24 fe-image"></i> Edit testimonial</h3>
                        </div>
                        <p>
                            <a href="{{ route('testimonial') }}" class="btn btn-primary btn-oval trigger-button"><i class="lni-list"></i> All</a>
                        </p>
                    </div>
                    {{-- Messages --}}
                    ...
                    @include('admin.includes.options',[
                        'redirectTo' => 'edit',
                        'redirectUrl' => '/testimonial/edit/',
                        'msg_type' => "success",
                        'msg' =>  "Created Successfully",
                        'post_type' =>  "testimonial"
                    ]) 
                    <input type="hidden" name="Post[sorting_no]" value="{{ $testimonial->sorting_no }}">
                    <div class="tile-content">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="inputSearch">Title</label>
                                    <input type="text" class="form-control mb-2" name="Post[name]" id="title" placeholder="Enter Title" value="{{ $testimonial->name }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="inputSearch">Slug</label>
                                    <input type="text" class="form-control mb-2" name="Post[slug]" id="slug" placeholder="" value="{{ $testimonial->slug }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12">
                    <div class="tile mb30">
                        ...
                        <div class="tile-content">
                            <div class="form-group"><label for="inputSearch">testimonial Content</label>
                                <textarea name="Post[content]" id="textarea1" class="form-control editor">{{ $testimonial->content }}</textarea>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="mb-4 position-relative">
                                            ...
                                            <img src="{{ asset(GetImageUrl($testimonial->Meta('testimonial'))) }}" alt="" id="preview_image" class="img-thumbnail" style="display:{{ ($testimonial->Meta('testimonial')) ? 'block' : 'none' }};">
                                            <input type="hidden" id="thumbnail" name="PostMeta[testimonial]" value="{{ $testimonial->Meta('testimonial') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Mobile testimonial Image</label>
                                        <div class="mb-4 position-relative">
                                            ...
                                            <img src="{{ asset(GetImageUrl($testimonial->Meta('mobile_testimonial'))) }}" alt="" id="mobile_preview_image" class="img-thumbnail" style="display:{{ ($testimonial->Meta('mobile_testimonial')) ? 'block' : 'none' }};">
                                            <input type="hidden" id="mobile_thumbnail" name="PostMeta[mobile_testimonial]" value="{{ $testimonial->Meta('mobile_testimonial') }}">
...
<script>
    jQuery("#testimonial_add").validate({
        ignore: [],
        rules: {
            "Post[name]": {
                required: true,
