...
<form action="{{ route('post.store') }}" id="testimonial_add" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="tile mb30">
                    <div class="tile-title-w-btn">
                        <div class="title">
                            <h3><i class="fe fe-24 fe-image"></i> Add Testimonials</h3>
                        </div>
                        <p>
                    ...
                    <input type="hidden" name="Post[sorting_no]" value="{{ $sorting_no }}">
                    <div class="tile-content">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="inputSearch">Person Name</label>
                                    <input type="text" class="form-control mb-2" name="Post[name]" id="title" placeholder="Enter Person Names">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                    ...
                    <div class="tile mb30">
                        ...
                        <div class="tile-content">
                            <div class="form-group"><label for="inputSearch">Testimonial Content</label>
                                <textarea name="Post[content]" id="textarea1" class="form-control editor"></textarea>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="mb-4 position-relative">
                                            ...
                                            <input type="hidden" id="thumbnail" name="PostMeta[testimonial]" value="">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Testimonial Mobile Image</label>
                                        <div class="mb-4 position-relative">
                                            ...
                                            <input type="hidden" id="mobile_thumbnail" name="PostMeta[mobile_testimonial]" value="">
